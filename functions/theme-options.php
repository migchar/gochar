...
Kirki::add_field( 'gridzone_theme', array(
	...
	'fields'		=> array(
		'social-title'	=> array(
			...
			'description'	=> esc_html__( 'Ex: Wechat', 'gridzone' ),
			'default'		=> '',
		),
		'social-icon'	=> array(
			'type'			=> 'text',
			'label'			=> esc_html__( 'Icon Name', 'gridzone' ),
			'description'	=> esc_html__( 'Font Awesome icons. Ex: icon-weixin ', 'gridzone' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'gridzone' ) . ' </strong></a>',
			'default'		=> 'icon-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
