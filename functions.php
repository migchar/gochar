...
if (!function_exists('gridzone_sidebars')) {
    ...
    function gridzone_sidebars()
    {
        ...
        if (get_theme_mod('footer-ads') == 'on') {
            register_sidebar(array('name' => esc_html__('Footer Ads', "gridzone"), 'id' => 'footer-ads', 'description' => esc_html__("Footer ads area", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }

        if (get_theme_mod('frontpage-widgets-top') == 'on') {
            register_sidebar(array('name' => esc_html__('Frontpage Top 1', 'gridzone'), 'id' => 'frontpage-top-1', 'description' => esc_html__("Frontpage area", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
        if (get_theme_mod('frontpage-widgets-top') == 'on') {
            register_sidebar(array('name' => esc_html__('Frontpage Top 2', 'gridzone'), 'id' => 'frontpage-top-2', 'description' => esc_html__("Frontpage area", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
        if (get_theme_mod('frontpage-widgets-bottom') == 'on') {
            register_sidebar(array('name' => esc_html__('Frontpage Bottom 1', 'gridzone'), 'id' => 'frontpage-bottom-1', 'description' => esc_html__("Frontpage area", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
        if (get_theme_mod('frontpage-widgets-bottom') == 'on') {
            register_sidebar(array('name' => esc_html__('Frontpage Bottom 2', 'gridzone'), 'id' => 'frontpage-bottom-2', 'description' => esc_html__("Frontpage area", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }

        if (get_theme_mod('footer-widgets') >= '1') {
            register_sidebar(array('name' => esc_html__('Footer 1', 'gridzone'), 'id' => 'footer-1', 'description' => esc_html__("Widgetized footer", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
        if (get_theme_mod('footer-widgets') >= '2') {
            register_sidebar(array('name' => esc_html__('Footer 2', 'gridzone'), 'id' => 'footer-2', 'description' => esc_html__("Widgetized footer", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
        if (get_theme_mod('footer-widgets') >= '3') {
            register_sidebar(array('name' => esc_html__('Footer 3', 'gridzone'), 'id' => 'footer-3', 'description' => esc_html__("Widgetized footer", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
        if (get_theme_mod('footer-widgets') >= '4') {
            register_sidebar(array('name' => esc_html__('Footer 4', 'gridzone'), 'id' => 'footer-4', 'description' => esc_html__("Widgetized footer", "gridzone"), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3 class="group"><span>', 'after_title' => '</span></h3>'));
        }
    }
...
if (!function_exists('gridzone_scripts')) {
    ...
    {
        wp_enqueue_script('gridzone-jquery', get_template_directory_uri() . '/js/jquery-3.5.1.min.js', array('jquery'), '', true);
        wp_enqueue_script('gridzone-bootstrap', get_template_directory_uri() . '/js/bootstrap.bundle.min.js', array('jquery'), '', true);
        wp_enqueue_script('gridzone-debouncer', get_template_directory_uri() . '/js/debouncer.js', array('jquery'), '', true);
        wp_enqueue_script('gridzone-char', get_template_directory_uri() . '/js/char.js', array('jquery'), '', true);
        ...
        wp_enqueue_script('gridzone-prism', get_template_directory_uri() . '/js/prism.js', array('jquery'), '', true);
        wp_enqueue_script('gridzone-iconfont', '//at.alicdn.com/t/font_1964167_u8c655nt0si.js', array('jquery'), '', true);
...
if (!function_exists('gridzone_styles')) {
    ...
    {
        wp_enqueue_style('gridzone-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css');
        ...
        if (get_theme_mod('dark', 'off') == 'on') {
            wp_enqueue_style('gridzone-dark', get_template_directory_uri() . '/dark.css');
        }
//        wp_enqueue_style('gridzone-font1', 'https://at.alicdn.com/t/font_1749284_yg9cfy8wd6.css');
//        wp_enqueue_style('gridzone-font2', 'https://at.alicdn.com/t/font_1749284_yg9cfy8wd6.css');
        wp_enqueue_style('gridzone-prism', get_template_directory_uri() . '/css/prism.css');
    }
            ...
            if (!empty($links)) {
                ...
                foreach ($links as $item) {
                    ...
                    if (isset($item['social-icon']) && !empty($item['social-icon'])) {
                        ...
                        $icon = ' class="icon" aria-hidden="true"><use xlink:href="#' . esc_attr($item['social-icon']) . '"></use>';
                    } else $icon = '';
                    ...
                    if (isset($item['social-title']) && !empty($item['social-title']) && isset($item['social-icon']) && !empty($item['social-icon']) && ($item['social-icon'] != 'fa-')) {
                        echo '<li><a rel="nofollow" class="social-tooltip" ' . $title . ' ' . $link . ' ' . $target . '><svg ' . $color . $icon . ' ' . '></svg></a></li>';
                    }
                }
                echo '</ul>';
            }
...
if (!function_exists('gridzone_site_title')) {
    ...
    function gridzone_site_title()
    {
        ...
        // Text or image?
        if (has_custom_logo()) {
            $logo = '<img id="header-logo" class="align-center" src="' . esc_url($logo[0]) . '" alt="' . esc_attr(get_bloginfo('name')) . '">';;
        } else {
            $logo = '';
        }

        $link = '<a class="nav-link nav-site-title" href="' . esc_url(home_url('/')) . '" rel="home">' . esc_html(get_bloginfo('name')) . '</a>';


        $sitename = '<h1 class="navbar-brand">' . $logo . $link . '</h1>' . "\n";
...
/* ------------------------------------ */
if (!function_exists('gridzone_related_posts_by_category')) {

    function gridzone_related_posts_by_category()
    {
        wp_reset_postdata();
        global $post;
...
if (!function_exists('gridzone_body_class')) {
    ...
    function gridzone_body_class($classes)
    {
        ...
        if (get_theme_mod('header-social')) {
            $classes[] = 'sidebar-social';
        }
...
function fluidchar_add_menu_classes_for_a($atts, $item, $args)
{
    $atts['class'] = 'nav-link';
...
add_filter('nav_menu_link_attributes', 'fluidchar_add_menu_classes_for_a', 10, 3);